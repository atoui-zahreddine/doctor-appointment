...
const Header = () => {
  ...
  return (
    <header className='bg-header p-6 sm:hidden'>
      <div className=' flex items-center justify-between'>
        <h1 className='text-252B42 text-2xl font-bold '>Physionic</h1>
        <nav className='flex space-x-6 items-center'>
          ...
          <svg
            ...
            <g>
              <path
                d='M7.99999 22.4002C8.88365 22.4002 9.59999 21.6838 9.59999 20.8002C9.59999 19.9165 8.88365 19.2002 7.99999 19.2002C7.11634 19.2002 6.39999 19.9165 6.39999 20.8002C6.39999 21.6838 7.11634 22.4002 7.99999 22.4002Z'
                fill='#737373'
              />
              <path
                d='M19.2 22.4002C20.0837 22.4002 20.8 21.6838 20.8 20.8002C20.8 19.9165 20.0837 19.2002 19.2 19.2002C18.3163 19.2002 17.6 19.9165 17.6 20.8002C17.6 21.6838 18.3163 22.4002 19.2 22.4002Z'
                fill='#737373'
              />
              <path
          ...
          <svg
            className='cursor-pointer'
            onClick={() => setIsOpen((prevState) => setIsOpen(!prevState))}
            width='24'
            height='14'
            viewBox='0 0 24 14'
            fill='none'
      ...
      <nav className={`transition ${isOpen ? '' : 'hidden'}`}>
        <ul className='flex flex-col py-8 px-12 space-y-6 items-center text-2xl'>
          <li>
            <a href='/' className='w-full h-full text-navText uppercase'>
              Home
            </a>
          </li>
          <li>
